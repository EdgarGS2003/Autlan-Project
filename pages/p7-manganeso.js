...
function renderManganeso() {
  ...
  el.innerHTML = `
    ...
    <div class="alert alert-warn mb-24">
      ...
      <span>
        El manganeso es el commodity principal de Autlán (~90% ingresos).
        A diferencia del oro o gas, <strong>no existe un mercado
        de derivados líquido y estandarizado</strong> para manganeso.
        Los instrumentos OTC existen pero son costosos y difíciles de cerrar.
        Precio actual:
        <strong>USD <span id="mn-precio-live">1,309</span>/MT</strong>
      </span>
    </div>
    ...
    <!-- CONTEXTO DE MERCADO -->
    <div class="section-title">Contexto del mercado de manganeso · 2026</div>
    <div class="grid-2 mb-24">
      <div class="card">
        <div class="card-header">
          <div class="card-title">Estructura del mercado</div>
          <span class="badge badge-warn">Mercado OTC limitado</span>
        </div>
        ${_mnMercadoEstructura()}
      </div>
      <div class="card">
        <div class="card-header">
          <div class="card-title">Drivers del precio</div>
          <span class="badge badge-accent">Q1 2026 · Máximo 17 meses</span>
        </div>
        ${_mnDriversPrecio()}
      </div>
    </div>
    ...
    <div class="section-title">
      Análisis de instrumentos disponibles · ¿Por qué el mercado OTC es limitado?
    </div>
    ...
    <!-- TABLA COMPARATIVA -->
    <div class="section-title">
      Impacto financiero por escenario · Sin instrumento formal
    </div>
    <div class="scenario-table-wrap mb-24">
      <table class="scenario-table">
        <thead>
          <tr>
            <th>Variable / Estrategia</th>
            <th class="esc-header-base">Base · $1,300/MT</th>
            <th class="esc-header-opt">Optimista · $1,600/MT</th>
            <th class="esc-header-adv">Adverso · $900/MT</th>
          </tr>
        </thead>
    ...
    <div class="section-title">Calculadora de exposición · Manganeso</div>
    <div class="card mb-24">
      <div class="grid-2">
        <div>
        ...
        <div id="mn-calc-result">
          <div class="alert alert-info">
            <span>Ajusta los parámetros para calcular la exposición.</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section-title">
      Estrategias de cobertura disponibles · Sin derivados listados
    </div>
    <div class="grid-2 mb-24" id="mn-estrategias"></div>

    <!-- OPORTUNIDADES ESTRUCTURALES -->
    <div class="section-title">
      Oportunidades estructurales · Catalizadores de largo plazo
    </div>
...
function _mnRenderKPIs() {
  ...
  el.innerHTML = [
    {
      label: "Precio Mn actual",
      value: `USD ${precio.toLocaleString()}/MT`,
      sub:   `Máximo 17 meses · Q1 2026 · Base: $1,309`,
    ...
    {
      label: "Ingresos ferroaleaciones est.",
      value: `USD ${(ingr/1000).toFixed(1)}M`,
      sub:   `~${volMT.toLocaleString()} MT/año · precio actual`,
      tipo:  "accent",
      delta: `${margen.toFixed(1)}% margen sobre costo`,
      dir:   margen > 30 ? "up" : "down",
    },
    {
      label: "Cobertura disponible",
      value: "Limitada",
      sub:   "No hay futuros listados · OTC muy costoso",
      tipo:  "warn",
      delta: "Contratos LP como alternativa",
      dir:   "down",
    },
    {
      label: "Pérdida escenario adverso",
      value: `USD ${((base - 900) * volMT / 1e6).toFixed(1)}M`,
      sub:   `Si precio cae a $900/MT (escenario adverso)`,
      tipo:  "danger",
  ...
  const items = [
    {
      ...
      desc:   "No existe un contrato de futuros estandarizado para " +
              "ferroaleaciones de manganeso en ninguna bolsa global " +
              "(LME, COMEX, SHFE). El ore de manganeso tampoco tiene " +
              "contrato líquido.",
      tipo:   "danger",
    },
    {
      titulo: "OTC existe pero es caro",
      desc:   "Forwards OTC con bancos especializados (BNP, SocGen, " +
              "Glencore Financial) existen pero requieren: volúmenes " +
              "mínimos de 10,000 MT+, spread bid-ask de 5-10%, y " +
              "colateral significativo.",
      tipo:   "warn",
    },
    {
      titulo: "Índice de referencia fragmentado",
      desc:   "Los precios CRU, Fastmarkets y Metal Bulletin son los " +
              "índices de referencia, pero son de acceso privado y " +
              "costoso. Sin índice público líquido = sin derivados " +
              "estandarizados.",
      tipo:   "warn",
    },
    {
      titulo: "China domina (61% global)",
      desc:   "Los precios del manganeso se mueven principalmente por " +
              "decisiones de China — inventarios en puertos chinos, " +
              "estímulo al sector acero y construction. Autlán no puede " +
              "influenciar ni predecir estos movimientos.",
      tipo:   "accent",
    },
  ];
...
function _mnDriversPrecio() {
  ...
  return `
    ...
    <div style="margin-top:10px; font-size:11px; color:var(--text-muted);">
      Fuente: IMARC Group Q1 2026 · CANACERO · Autlán Annual 2025
    </div>
  `;
}
...
function _mnRenderDerivadosAnalisis() {
  ...
  el.innerHTML = `
    <div class="grid-2" style="gap:24px;">
      ...
      <div>
        <div class="section-title" style="margin-top:0;">
          ¿Por qué nadie cierra derivados OTC de manganeso?
        </div>
          ...
          ${[
            {
              ...
              desc: `El spread típico en forwards OTC de manganeso es 7-10%
                     del nocional. Sobre USD ${(precio*vol/1e6).toFixed(1)}M de
                     ingresos anuales, eso es un costo implícito de
                     USD ${costoForward.toFixed(0)}K solo por entrar en
                     la posición — antes de cualquier movimiento de precio.`,
            },
            {
              num: "2",
              titulo: "Precio de referencia no estandarizado",
              desc: `El settlement de un forward necesita un índice de
                     referencia público y líquido. Los índices de manganeso
                     (CRU, Fastmarkets) son privados y sus metodologías
                     son disputadas — las contrapartes no se ponen de
                     acuerdo en el precio de liquidación.`,
            },
            {
              num: "3",
              titulo: "Volumen mínimo muy alto",
              desc: `Los bancos que ofrecen forwards de manganeso (BNP
                     Paribas, Standard Chartered) requieren lotes mínimos
                     de 10,000-50,000 MT por operación. Autlán produce
                     ~55,000 MT/año — cubrirlo requeriría una sola
                     operación que concentra todo el riesgo de contraparte.`,
            },
            {
              num: "4",
              titulo: "Riesgo de base muy alto",
              desc: `El precio que recibe Autlán de sus clientes (precio
                     de contrato) difiere significativamente del índice
                     spot de referencia. El basis risk puede ser tan alto
                     como el riesgo de precio que se intenta cubrir.`,
            },
          ].map(i => `
      ...
      <div>
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>
              ${[
                ["Forward OTC banco",
                 "Baja — pocos oferentes",
                 `~7-10% nocional (USD ${costoForward.toFixed(0)}K)`,
                 "⚠ Costo alto"],
                ["Futuros bolsa",
                 "No disponible",
                 "N/A — no existe contrato",
                 "✗ No aplicable"],
                ["Opciones sobre Mn",
                 "Prácticamente nula",
                 "Spread + prima = prohibitivo",
                 "✗ No recomendado"],
                ["Contrato LP precio fijo",
                 "Alta — con clientes",
                 "Descuento 2-5% vs spot",
                 "✓ Estrategia principal"],
                ["Cobertura natural (costos)",
                 "Alta — ya existe parcialmente",
                 "Inversión capex autogeneración",
                 "✓ Complementaria"],
                ["Diversificación productos",
                 "Alta — EMD y Metallorum",
                 "Capex en expansión",
                 "✓ Estructural"],
              ].map(([inst, disp, costo, rec]) => `
                <tr>
                  ...
                  <td style="font-size:11.5px; font-weight:600;
                      color:${rec.startsWith("✓") ? "var(--success)"
                             : rec.startsWith("⚠") ? "var(--warn)"
                             : "var(--danger)"};">
                    ${rec}
                  </td>
                </tr>`).join("")}
        ...
        <div class="alert alert-info" style="margin-top:12px;">
          ...
          <span style="font-size:11.5px;">
            <strong>Conclusión:</strong> El costo implícito del forward
            OTC (~USD ${costoForward.toFixed(0)}K) como porcentaje del
            margen operativo hace que la cobertura natural via contratos
            de largo plazo con clientes sea más eficiente.
          </span>
        </div>
      </div>
...
window.calcMnExposicion = function() {
  ...
  el.innerHTML = `
    ...
    <div class="alert alert-${margenPct > 15 ? "success" : margenPct > 0 ? "warn" : "danger"}"
      ...
      <span style="font-size:11.5px;">
        Con ${(pctFijo*100).toFixed(0)}% de ventas en contratos LP a
        $${precioLP}/MT, el margen bruto es
        ${margenPct.toFixed(1)}%.
        ${margenAdv > 0
          ? `En el escenario adverso ($900/MT), el LP protege
             y el margen sigue siendo positivo.`
          : `En el escenario adverso ($900/MT), el margen
             es negativo — el LP no compensa suficientemente.
             Aumentar % de contratos LP o reducir costos.`}
      </span>
    </div>
  `;
};
  ...
  const estrategias = [
    {
      ...
      icono:    "📋",
      tipo:     "success",
      desc:     `La estrategia más efectiva disponible. Autlán puede ofrecer
                 descuentos de 2-5% sobre el precio spot a cambio de contratos
                 de suministro de 12-36 meses con precio fijo o indexado.
                 Esto convierte la exposición al spot en ingresos predecibles.`,
      ventajas: [
    ...
    },
    {
      ...
      icono:    "🏭",
      tipo:     "accent",
      desc:     `Autlán tiene integración vertical — posee las minas y las
                 plantas de fundición. Sus costos están relativamente fijos
                 en MXN. Cuando el precio del Mn baja, el margen comprime
                 pero los costos no suben proporcionalmente. La autogeneración
                 de energía amplifica esta protección natural.`,
      ventajas: [
    ...
    },
    {
      ...
      icono:    "⚡",
      tipo:     "accent",
      desc:     `EMD (electrolytic manganese dioxide) para baterías y
                 Metallorum (oro) son los dos segmentos que rompen la
                 correlación con el ciclo del acero. La meta de Metallorum
                 (15% ingresos para 2028) actúa como cobertura natural
                 porque el oro sube en escenarios de risk-off donde
                 el manganeso típicamente cae.`,
      ventajas: [
    ...
    },
    {
      ...
      icono:    "🌍",
      tipo:     "gold",
      desc:     `Gabon bana la exportación de mineral de manganeso crudo
                 en enero 2029. Como productor integrado con minas propias,
                 Autlán puede posicionarse AHORA para capturar el alza
                 estructural de precios que esto generará, asegurando
                 contratos LP de largo plazo con clientes que buscarán
                 seguridad de suministro antes del ban.`,
      ventajas: [
  ...
  el.innerHTML = estrategias.map(e => `
    <div class="card">
      <div class="card-header">
        ...
        <span class="badge badge-${e.tipo}">${e.tipo.toUpperCase()}</span>
      </div>
      ...
      <div class="grid-2" style="gap:12px;">
        <div>
          <div style="font-size:10px; color:var(--success);
                      font-weight:700; margin-bottom:6px;">VENTAJAS</div>
          ${e.ventajas.map(v => `
        ...
        <div>
          <div style="font-size:10px; color:var(--danger);
                      font-weight:700; margin-bottom:6px;">CONSIDERACIONES</div>
          ${e.desventajas.map(d => `
            <div style="font-size:11px; color:var(--text-secondary);
                        margin-bottom:4px; display:flex; gap:6px;">
  ...
  const cats = [
    {
      ...
      desc:   `Gabon representa ~25% del supply global de mineral de alta ley.
               El ban obliga a los compradores a buscar alternativas —
               productores integrados como Autlán ganan pricing power y
               seguridad contractual. El uplift estimado es USD 50-100/MT
               para productores con captive ore a partir de 2029.`,
      accion: "Firmar contratos LP de 3-5 años ahora con clientes " +
              "que buscan seguridad de suministro pre-2029.",
    },
    {
      titulo: "India — crecimiento estructural de acero",
      cert:   "Alta probabilidad",
      color:  "var(--accent-mid)",
      desc:   `India creció +6.3% en producción de acero en 2024 y continúa
               expandiendo. Con capacidad instalada de 300 Mt para 2030,
               India será el segundo consumidor mundial de manganeso.
               Autlán tiene ventaja geográfica para exportar via Pacífico.`,
      accion: "Desarrollar relaciones comerciales con productores de acero " +
              "indios — Tata Steel, JSW Steel, SAIL.",
    },
    {
      titulo: "Baterías LMFP — nuevo mercado",
      cert:   "Media probabilidad · Largo plazo",
      color:  "var(--warn-mid)",
      desc:   `La química LFP (litio-hierro-fosfato) está evolucionando a
               LMFP (con manganeso) para mejorar densidad energética.
               Autlán ya tiene capacidad de HPMSM (sulfato de manganeso
               de alta pureza) — el insumo clave para baterías de EV.
               Confirmación de calidad por clientes en Q1 2025.`,
      accion: "Escalar producción de HPMSM en EMD. " +
              "Certificar con OEMs de EV para contratos 2027+.",
    },
  ];
  ...
  el.innerHTML = `
    ...
    <div class="alert alert-${precio > 1300 ? "success" : "warn"}"
      ...
      <span style="font-size:12px;">
        ...
        Con precio en USD ${precio.toLocaleString()}/MT
        (máximo de 17 meses), Autlán está en el momento óptimo
        para negociar contratos LP con clientes a precios favorables —
        bloqueando el nivel actual antes de cualquier corrección.
      </span>
    </div>
  `;
}
...
function _mnRenderRecomendacion() {
  ...
  el.innerHTML = `
    <div class="card-title" style="margin-bottom:16px;">
      Análisis de postura · Manganeso USD ${precio.toLocaleString()}/MT
    </div>
    ...
    <div class="grid-3" style="gap:16px; margin-bottom:16px;">
      <div style="padding:14px; background:var(--bg-raised);
        ...
        <div style="font-size:12px; line-height:1.6;">
          Caída en precio del manganeso impulsada por debilidad
          de demanda china, oversupply australiano o intensificación
          del dumping asiático en México. Con ~90% de ingresos en
          ferroaleaciones, Autlán tiene concentración máxima
          en un solo commodity sin cobertura financiera formal.
        </div>
      </div>
      <div style="padding:14px; background:var(--bg-raised);
                  border-radius:var(--radius-md);
        ...
        <div style="font-size:11px; font-weight:700;
          ...
          POR QUÉ NO HAY DERIVADOS EFICIENTES
        </div>
        <div style="font-size:12px; line-height:1.6;">
          El mercado OTC de manganeso existe pero es ineficiente:
          spread bid-ask de 7-10%, volúmenes mínimos muy altos,
          índice de referencia fragmentado y basis risk elevado.
          El costo implícito hace que la cobertura financiera
          destruya más valor del que protege.
        </div>
      </div>
      <div style="padding:14px; background:var(--bg-raised);
                  border-radius:var(--radius-md);
        ...
        <div style="font-size:12px; line-height:1.6;">
          <strong>Triple estrategia:</strong>
          (1) Contratos LP precio fijo con top 6 clientes
          para 30-40% del volumen.
          (2) Posicionamiento anticipado para Gabon ban 2029.
          (3) Acelerar Metallorum hacia 15% de ingresos
          como cobertura natural anti-cíclica.
        </div>
      </div>
    </div>
    ...
    <div class="alert alert-${precio > 1300 ? "success"
      ...
      <span style="font-size:12px;">
        <strong>Postura actual:</strong>
        ${precio > 1300
          ? `Precio favorable (USD ${precio.toLocaleString()}/MT).
             Momento óptimo para fijar contratos LP con clientes
             antes de cualquier corrección. La cobertura natural
             vía integración vertical mantiene márgenes positivos
             incluso en escenario base.`
          : precio > 1000
          ? `Precio en zona intermedia (USD ${precio.toLocaleString()}/MT).
             Margen positivo pero comprimido. Priorizar contratos LP
             y reducir costos operativos. Evaluar ajuste de mix
             de ventas hacia mercados con mejores márgenes (EEUU vs México).`
          : `Precio en zona crítica (USD ${precio.toLocaleString()}/MT).
             Con precio cerca del costo de producción (~$900/MT),
             el foco debe ser reducción de costos y drawdown de
             líneas de crédito para cubrir el ciclo adverso.
             Metallorum como fuente crítica de FCF alternativo.`}
      </span>
    </div>
  `;
}
